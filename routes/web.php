...
Route::middleware(['auth:sinh_vien'])->group(function () {
    Route::get('/sinh-vien/trang-chu', [SinhVienController::class, 'trangChu'])->name('sinh_vien.trang_chu');
});

Route::middleware(['auth:giao_vien'])->group(function () {
...
Route::middleware(['auth:tro_ly_khoa'])->group(function () {
    Route::get('/tro-ly_khoa/trang-chu', [TroLyKhoaController::class, 'trangChu'])->name('tro_ly_khoa.trang_chu');
});
